...
public class servicepayment {
	...
	public gopaymentresponse dobulkpayment(bulkpaymentrequest aReq) {
		GeneralUtil.writeDebugLog(aReq.getToken(), "Do Bulk Payment Request Message : ", GeneralUtil.toGson(aReq));
		...
		if(!vres.getCode().equalsIgnoreCase("300")){
			...
			GeneralUtil.writeDebugLog(aReq.getToken(), "Do Bulk Payment Response Message : ", GeneralUtil.toGson(response));
			return response;
		} 
		try {
	...
	public gopaymentresponse domerchantpaymentnew(merchantpaymentdatareq aReq) {
		GeneralUtil.writeDebugLog(aReq.getToken(), "Do bill Request Message : ", GeneralUtil.toGson(aReq));
		gopaymentresponse response = new gopaymentresponse();
		service003Mgr sbmgr = new service003Mgr();
		ResponseData vres = new ResponseData();
		...
		if(!vres.getCode().equalsIgnoreCase("300")){
			response.setRetcode(vres.getCode());
			response.setRetmessage(vres.getDesc());
			GeneralUtil.writeDebugLog(aReq.getToken(), "Do bill Response Request Message : ", GeneralUtil.toGson(response));
			return response;
		} 
			try {
	...
	public gopaymentresponse dopaymenttopupnew(paymenttopupreq aReq) {
		GeneralUtil.writeDebugLog(aReq.getToken(), "Do mobile-topup Request Message : ", GeneralUtil.toGson(aReq));
		gopaymentresponse response = new gopaymentresponse();
		service003Mgr sbmgr = new service003Mgr();
		ResponseData vres = new ResponseData();
		...
		if(!vres.getCode().equalsIgnoreCase("300")){
			response.setRetcode(vres.getCode());
			response.setRetmessage(vres.getDesc());
			GeneralUtil.writeDebugLog(aReq.getToken(), "Do mobile-topup Response Message : ", GeneralUtil.toGson(response));
			return response;
		} 
			try {
	...
	public gopaymentresponse domerchanttransfernew(acctransferreq aReq) {
		GeneralUtil.writeDebugLog(aReq.getToken(), "Do wallet-topup Request Message : ", GeneralUtil.toGson(aReq));
		gopaymentresponse response = new gopaymentresponse();
		...
		try {
			...
			if (!validateResult.isState()) {
				...
				GeneralUtil.writeDebugLog(aReq.getToken(), "Do wallet-topup Response Message : ", GeneralUtil.toGson(response));
				return response;
			}
	...
	@POST
	@Path("reversal-wallet-topup")
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public gopaymentresponse reversalmerchanttransfer(acctransferreq aReq) {
		
		//GeneralUtil.readDebugLogStatus();
		GeneralUtil.writeDebugLog(aReq.getToken(), "Do reversal-wallet-topup Request Message : ", GeneralUtil.toGson(aReq));
		...
		if (!validateResult.isState()) {
			...
			//GeneralUtil.readDebugLogStatus();
			GeneralUtil.writeDebugLog(aReq.getToken(), "Do reversal-wallet-topup Response Message : ", GeneralUtil.toGson(response));
